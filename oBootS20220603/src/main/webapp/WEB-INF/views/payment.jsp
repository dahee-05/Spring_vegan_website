...
<script type="text/javascript">
	 ...
	 $(function() {
			...
			$('#selectCoupon').click(function() {
				window.open("/couponList","","width=600px,height=600px");
			});
							...
							<table class="table" id="p_list">
							    ...
							    <tbody>
							    	<c:if test="${from == 0 }">
										...
										<tr>
										    <td class="p_img"><img src="../upload/${product.th_img }"></td>
					...
					<div id="right_side">
						...
						<div id="pay">
							...
							<ul class="cp_arrange clearfix">
								...
								<li class="right">
									<p><fmt:formatNumber value="${prod_amount }" groupingUsed="true"></fmt:formatNumber>원</p>
							...
							<input type="hidden" name="prod_amount" id="prod_amount" value="${prod_amount }">
